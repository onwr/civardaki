...
const MENU_PRESETS = [
  {
    id: "civardaki_operasyon",
    title: "Operasyon odaklı",
    description: "Talepler, siparişler ve mağaza vitrinini öne alır.",
    ...
    orderPriority: [
      ...
      "/business/leads",
      "/business/orders",
      "/business/civardaki-magaza",
      "/business/products",
      "/business/analytics",
    ],
    hidden: ["/business/ekran-kilidi"],
    children: {},
  },
  {
    id: "civardaki_randevu",
    title: "Randevu ve takvim",
    description: "Takvim, rezervasyon ve talepleri üst sıralara taşır.",
    allowedTypes: [BusinessTypes.INDIVIDUAL, BusinessTypes.CORPORATE],
    icon: UserIcon,
    orderPriority: [
      "/business/dashboard",
  ...
  },
  {
    id: "civardaki_sade",
    title: "Sade panel",
    description: "Daha az menü; vitrin ve temel araçlar.",
    allowedTypes: [BusinessTypes.INDIVIDUAL, BusinessTypes.CORPORATE],
    icon: Squares2X2Icon,
    orderPriority: [
      "/business/dashboard",
