  ...
  return (
    <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-slate-200/60 bg-white px-6 py-4 sm:flex-row">
      ...
      <div className="flex items-center gap-2">
        <Link
          href={prevHref}
          className={`flex h-10 items-center gap-2 rounded-xl border border-slate-200 px-4 text-sm font-semibold transition-all ${
            safePage <= 1
        ...
        <div className="hidden items-center gap-1 sm:flex">
          {visiblePages.map((pageNo) => (
            <Link
              ...
              className={`flex h-10 min-w-10 items-center justify-center rounded-xl text-sm font-bold transition-all ${
                pageNo === safePage
      ...
      <div className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-[#004aad]/10 px-3 py-1 text-xs font-semibold text-[#004aad]">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Isletmelerin pazaryerinde yayinladigi urunleri kesfedin
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link
                ...
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 text-sm font-semibold text-slate-700 transition-all hover:border-slate-300 hover:bg-slate-50"
              >
              ...
              <Link
                ...
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-[#004aad] px-5 text-sm font-semibold text-white transition-all hover:bg-[#003d8f]"
              >
