            ...
            {TABS.map(({ id, label, Icon }) => {
              ...
              return (
                <button
                  ...
                  className={`flex min-h-[44px] items-center gap-2 rounded-t-lg px-3 py-3 text-[11px] font-bold uppercase tracking-wide transition md:px-4 md:text-xs ${
                    active
