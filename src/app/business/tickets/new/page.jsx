          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm leading-6 text-white/80 md:text-[15px]">
                Teknik sorun, ödeme, abonelik, içerik düzenleme veya panel
                kullanımıyla ilgili konularda ekibimize detaylı bir talep
                iletebilirsiniz.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Yaşadığınız durumu, hata adımlarını ve beklediğiniz sonucu mümkün olduğunca detaylı yazın..."
              />
              <div className="text-right text-xs text-slate-400">
        ...
        <aside className="space-y-4">
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-sm font-semibold text-slate-900">
              İyi bir destek talebi için
            </h2>
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
              <li>Konuyu net ve kısa bir başlıkla özetleyin.</li>
              <li>Hatanın hangi sayfada veya işlemde oluştuğunu belirtin.</li>
              <li>Mümkünse adım adım ne yaptığınızı yazın.</li>
              <li>
                Ödeme veya abonelik konusuysa tarih ve paket bilgisini ekleyin.
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Destek talepleri oluşturulduktan sonra ekip tarafından incelenir
              ve durum güncellemeleri talep detay ekranında görüntülenebilir.
            </p>
          </div>
        </aside>
      </div>
